...
category: Hack
image: http://giantech.jp/assets/images/20150526/standingdesk.jpg
...
（そもそも、スタンディング環境でツライという状態は、仕事とかパソコンを触ってはいけない状態だと考えると、むしろ強制的に体が辛い時は仕事をしない（できない）という制約となって、心と身体によいと考えたほうがよさそうだ。）
...
設計意図と異なる振る舞いを続けることで、身体に負担が蓄積される。その負担を解消するために、本質的な問題（座り続けること）を解決しないまま、その場をしのぐ解決策が考え出されたが、本質的な問題は依然として解決しない、というのが椅子にまつわる問題構造だと感じる。
